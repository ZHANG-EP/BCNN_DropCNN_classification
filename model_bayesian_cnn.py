...
from defaults import BAYESIAN_CNN_TRAIN_RESULTS_SAVE, MODEL_SAVE_PATH_BAYESIAN_CNN, TIME_TRAIN_BAYESIAN_CNN_SAVE,TRAIN_LOSS_BAYESIAN_CNN_SAVE,TRAIN_ACC_BAYESIAN_CNN_SAVE
